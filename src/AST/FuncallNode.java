...
public class FuncallNode extends ExprNode {
    ...
    public void add(ExprNode expr) {args.add(0, expr);}
    public void add_this_pointer(ExprNode expr) {args.add(0, expr);}
    public FunctionType function_type() {return (FunctionType) expr.getType();}
