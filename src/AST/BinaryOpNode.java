...
public class BinaryOpNode extends ExprNode {
    public enum BinaryOp{ADD, SUB, MUL, DIV, MOD, LSHIFT, RSHIFT, LT, GT, LE, GE, EQ, NE, BIT_AND, BIT_OR, BIT_XOR, LOGIC_AND, LOGIC_OR}
    ...
    public void setOperator(BinaryOp operator) {this.operator = operator;}
