...
public class ArrayType extends Type {
    ...
    static public void initialize_builtin_function()
    {
        ...
        scope.insert(new LibFunction(integerType, "size", "__lib_" + "array_size", new Type[]{magicArray}).get_entity());
    }

    static private Scope scope;
    static public Scope scope() {return scope;}
    public Type deep_type() {return base_type instanceof ArrayType ? ((ArrayType) base_type).deep_type() : base_type;}
    public Type base_type() {return base_type;}
    ...
    public boolean is_compatible(Type other)
    {
        ...
        return base_type.is_compatible(((ArrayType)other).base_type());
    }
}